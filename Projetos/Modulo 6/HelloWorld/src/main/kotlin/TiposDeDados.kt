...
fun main() {
    ...
    // É possível declarar uma variável sem tipo, desde que seja inicializada.
    // O tipo de dado é definido através da inferência.
    var idade = 18
    ...
    // Atenção a declaração de tipo
    val n1 = 10.0 // Qualquer número com ponto flutuuante é tratado como Double.
    val n2 = 10.0F // "F" ou "f" faz com que o tip agora seja Float.
    val n3 = 13 // Número inteiro, caso caiba dentro do Int, será inteiro.
    val n4 = 13L // Long.
    val n5: Byte = 13 // Não existe sufixo para Byte ou Short, caso deseje um tipo Byte, deve ser explícito.
    val n6: Short = 13 // Não existe sufixo para Byte ou Short, caso deseje um tipo Short, deve ser explícito.
 ...
 * Porém o tamanho depende da JVM e a especificação não deixa claro.
 *
 * String
 * O tamanho de um String depende de seu conteúdo.
 *
 * Fonte
